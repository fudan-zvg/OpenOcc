...
class DinoDecoder(nn.Module):
    def __init__(self, W=128, D=4, skips=[], input_feat_dim=16, n_freq=-1, weight_norm=False, concat_qp=False):
        super(DinoDecoder, self).__init__()
...
class NeRFDecoder(nn.Module):
    def __init__(self, geometry_kwargs, radiance_kwargs, semantic_kwargs, dino_kwargs, occ_feat_dim, rgb_feat_dim, semantic_feat_dim, dino_feat_dim):
        super(NeRFDecoder, self).__init__()
        self.geometry_net = GeometryDecoder(**geometry_kwargs, input_feat_dim=occ_feat_dim)
        self.radiance_net = RadianceDecoder(**radiance_kwargs, input_feat_dim=rgb_feat_dim)
        self.semantic_net = SemanticDecoder(**semantic_kwargs, input_feat_dim=semantic_feat_dim)
        self.dino_net = DinoDecoder(**dino_kwargs, input_feat_dim=dino_feat_dim)
